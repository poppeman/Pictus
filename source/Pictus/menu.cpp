...
namespace Win {
	...
	uint32_t Menu::AddItem(App::StringID str_id)
	{
		auto mi = std::make_shared<MenuItem>(m_currId++);
	...
	{
		auto mi = std::make_shared<SubMenu>();
	...
	{
		auto mi = std::make_shared<Separator>();
