...
namespace App {
	...
	const std::map<wxKeyCode, App::StringID> cg_keySids = {
		...
		{ WXK_NUMPAD_MULTIPLY, SIDKeysNumMult },
		{ WXK_NUMPAD_ADD, SIDKeysNumPlus },
		{ WXK_NUMPAD_SEPARATOR, SIDKeysNumSeparator },
		{ WXK_NUMPAD_SUBTRACT, SIDKeysNumMinus },
		{ WXK_NUMPAD_DECIMAL, SIDKeysNumDecimal },
		{ WXK_NUMPAD_DIVIDE, SIDKeysNumDivide },
		// 0x70
		{ WXK_F1, SIDKeysF1 },
		{ WXK_F2, SIDKeysF2 },
		{ WXK_F3, SIDKeysF3 },
